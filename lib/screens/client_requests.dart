...
import 'package:event_planner/screens/accessories_requested_details.dart';
...
class _ClientRequestsScreenState extends State<ClientRequestsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Container(
      padding: EdgeInsets.symmetric(vertical: 20, horizontal: 0.068 * width),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Accessories you requested",
